...
public class Lesson2_Hw {
    ...
    public void runExercises() throws IOException, URISyntaxException {
        URL url = this.getClass().getClassLoader().getResource("SonnetI.txt");
        resourcesPath = Paths.get(url.toURI()).getParent().toString() + "/";
    ...
    private void exercise4() throws IOException {
        try (BufferedReader reader = Files.newBufferedReader(
                Paths.get(resourcesPath + "SonnetI.txt"), StandardCharsets.UTF_8)) {
        /* YOUR CODE HERE */
            System.out.println(reader.lines().count());
        }

        System.out.println(Files.lines(Paths.get(resourcesPath + "SonnetI.txt")).count());
    }
    ...
    private void exercise5() throws IOException {
      ...
      /* YOUR CODE HERE */
        ...
        System.out.println(
                Files.lines(Paths.get(resourcesPath + "SonnetI.txt"))
                        .flatMap((String l) -> Stream.of(l.split(WORD_REGEXP)))
                        .map(String::toLowerCase)
